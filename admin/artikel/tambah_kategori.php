<?php
    ...
    if (isset($_POST['tambah_kategori'])) {
        ...
        if ($_SERVER["REQUEST_METHOD"] == "POST") {
            ...
            $simpan_kategori=mysqli_query($con,$sql);
...
?>
<form action="artikel/tambah_kategori.php" method="post" enctype="multipart/form-data">
    <!-- rows -->
    <div class="row">
        <div class="col-sm-10">
        ...
        <div class="col-sm-6">
            <div class="form-group">
                ...
                <input type="file" name="gambar_kategori" class="file" >
                    ...
                    <img src="gambar_up.png" id="preview" class="img-thumbnail">
            </div>
        </div>
    </div>
