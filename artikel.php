<?php
    ...
    $query = mysqli_query ($con,"select * from artikel a inner join kategori k on k.id_kategori=a.id_kategori where id_artikel='".$id_artikel."' limit 1");
    ...
    <div class="col-sm-8">
        <div class="thumbnail">
            ...
            <?php
                  if (isset($_GET['komentar'])) {
                    ...
                    if ($_GET['komentar']=='berhasil'){
                        echo"<div class='alert alert-success'>Komentar telah terkirim</div>";
                    }else {
            ...
            <div class="row">
                <?php
                    include 'koneksi/koneksi.php';
                    $sql="select * from komentar where id_artikel=$id_artikel and status_komen=1 order by id_komen desc";
