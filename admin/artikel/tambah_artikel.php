...
$query = mysqli_query($con, "SELECT max(id_artikel) as kodeTerbesar FROM artikel");
...
?>
<form action="artikel/function_tambah_artikel.php" method="post" enctype="multipart/form-data">
    <!-- rows -->
    <div class="row">
        <div class="col-sm-12">
